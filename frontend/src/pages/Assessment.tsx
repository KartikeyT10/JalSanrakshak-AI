...
const Assessment: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-sky">
      ...
      <div className="pt-24 pb-16 min-h-screen relative overflow-hidden bg-background">
        {/* Background ambient light */}
        <div className="fixed inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-sky-blue/20 via-background to-background -z-20 pointer-events-none" />
